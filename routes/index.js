...
var obj = {
  ...
  html: nombre + " " + apellido  +  "se ha contactado a traves de la web y desea mas info a este correo:" +  email  + ". <br> Además, realizo el siguiente comentario:" + mensaje + ".<br> su telefono es " + telefono
}//cierra var obj
